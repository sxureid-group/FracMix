...
class build_transformer(nn.Module):
    def __init__(self, num_features=0, norm=True, BNNeck=True, conv_stem=False):
        ...
        self.base = TransReID(
            ...
            drop_rate=0.0, attn_drop_rate=0.0, conv_stem=conv_stem)
    ...
    def forward(self, x):
        ...
        x, x_rb, out, topk_weight = self.base(x)
